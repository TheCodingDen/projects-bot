...
const config = {
  rejection: () => ({
    ...
    templates: {
      'no-license': ({ user }: RejectionParams) => `${user}, your project has been rejected because does not contain a valid LICENSE, LICENSE.txt or LICENSE.md file. Please add a license to your project and resubmit. See <https://choosealicense.com/> for more information`,
      ...
      'invalid-id': ({ name }: RejectionParams) => `To whomever submitted "${name}", the provided ID was invalid. You must resubmit with a valid user ID for your project to be reviewed. For help with getting your ID, see <https://support.discord.com/hc/en-us/articles/206346498-Where-can-I-find-my-User-Server-Message-ID->`,
